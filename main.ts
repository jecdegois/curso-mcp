...
server.tool(
  ...
  async ({ city }) => {
    ...
    const weatherResponse = await fetch(`https://api.open-meteo.com/v1/forecast?latitude=${latitude}&longitude=${longitude}&hourly=temperature_2m&current=precipitation,temperature_2m,relative_humidity_2m`)
